  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        <li class="active"><a href="?m=admin&c=article&a=article_list">文章</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="?m=admin&c=article&a=doupdate" method="post" class="add-article-form" enctype="multipart/form-data">
          <div class="col-md-9">
            <h1 class="page-header">文章修改</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">标题</label>
              <input type="text" id="article-title" name="article_name" class="form-control" placeholder="在此处输入标题" value="<?=$arr['article_name'];?>" required autofocus autocomplete="off">
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
              <script id="article-content" name="article_content" type="text/plain"><?=$arr['article_content'];?></script>
            </div>  
          </div>
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                  ...
                  <li>
                    <label>
                      <input name="type_id" type="radio" value="<?=$value['bid'];?>">
                      <?=$value['bname'];?> <em class="hidden-md">( 栏目ID: <span><?=$value['bid'];?></span> )</em></label>
                  </li>
                  <?php endforeach;?>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <img src="<?=$arr['article_image'];?>" style="height:50px; width:50px; border:1px solid #ccc">
              </div>
              <div class="add-article-box-footer">
                <input name="img" type="file" style="height:35px; width:300px; " class="btn btn-default" />
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <p><label>公开度：</label><input type="radio" name="article_type" value="0" checked/>公开 <input type="radio" name="article_type" value="1" />加密</p>
                <p><label>发布于：</label><span class="article-time-display"><input style="border: none;" type="datetime" name="create_time" value="2016-01-09 17:29:37" /></span></p>
              </div>
              <div class="add-article-box-footer">
...
<script id="public/admin/uploadEditor" type="text/plain" style="display:none;"></script>
