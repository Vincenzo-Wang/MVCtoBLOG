...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="?m=admin&c=article&a=deleteAll" method="post" >
        <h1 class="page-header">操作</h1>
        <ol class="breadcrumb">
          <li><a href="?m=admin&c=article&a=add">增加文章</a></li>
        </ol>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="<?=$value['article_id'];?>" /></td>
                <td class="article-title"><?=$value['article_name'];?></td>
                <td><?=$value['type_id'];?></td>
                <td class="hidden-sm">PHP、JavaScript</td>
                <td class="hidden-sm">0</td>
                <td><?=$value['article_time'];?></td>
                <th><a href="?m=admin&c=article&a=update&article_id=<?=$value['article_id'];?>">修改</a> <a rel="6" href="?m=admin&c=article&a=deleteArticle&article_id=<?=$value['article_id'];?>">删除</a></th>
              </tr>
              <?php endforeach;?>
              <?php endif;?>
